...
public interface MinXML extends List< @NonNull MinXML > {
	...
	default @NonNull MinXML getFirst() {
		return this.get( 0 );
	}
	
	default @NonNull MinXML getLast() {
		return this.get( this.size() - 1 );
	}
	
	default @NonNull MinXML removeFirst() throws UnsupportedOperationException {
		return this.remove( 0 );
	}
	
	default @NonNull MinXML removeLast() throws UnsupportedOperationException {
