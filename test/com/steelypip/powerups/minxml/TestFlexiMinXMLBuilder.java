...
public class TestFlexiMinXMLBuilder {
	...
	public void unmatchedStartTags() {
		builder.startTagOpen( "foo" );
		builder.build();
	}

	@Test( expected = Exception.class )
	public void tooManyCloseTags() {
		builder.endTag( "foo" );
		builder.build();
	}
	...
	public void buildTwo() {
		builder.startTagOpen( "foo" );
		builder.startTagClose( "foo" );
		builder.endTag( "foo" );
		builder.startTagOpen( "bar" );
		builder.startTagClose( "bar" );
		builder.endTag( "bar" );
		assertEquals( "foo", builder.build().getName() );
		assertEquals( "bar", builder.build().getName() );
	}
